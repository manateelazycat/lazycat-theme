...
(custom-set-faces
 ...
 '(company-tooltip-common ((t (:inherit company-tooltip :foreground "#30A339"))))
 '(company-tooltip-common-selection ((t (:background "gray20" :foreground "#30A339"))))
 '(company-tooltip-selection ((t (:background "gray20" :foreground "#30A339"))))
 ...
 '(font-lock-keyword-face ((((class color) (min-colors 88) (background dark)) (:foreground "#FF9933"))))
