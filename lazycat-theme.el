...
;; Set face.
(custom-set-faces
 '(default ((t (:background "black" :foreground "#2EB939"))))
 ...
 '(company-tooltip-common ((t (:inherit company-tooltip :foreground "#2EB939"))))
 '(company-tooltip-common-selection ((t (:background "gray20" :foreground "#2EB939"))))
 '(company-tooltip-selection ((t (:background "gray20" :foreground "#2EB939"))))
 ...
 '(diredp-file-name ((t (:foreground "#2EB939"))))
 ...
 '(font-lock-constant-face ((((class color) (min-colors 88) (background dark)) (:foreground "#9F7DEF"))))
 '(font-lock-doc-face ((t (:inherit font-lock-string-face :foreground "#5C6A7C"))))
 '(font-lock-function-name-face ((((class color) (min-colors 88) (background dark)) (:foreground "#ADDA46"))))
 '(font-lock-keyword-face ((((class color) (min-colors 88) (background dark)) (:foreground "#E73C70"))))
 ...
 '(font-lock-variable-name-face ((((class color) (min-colors 88) (background dark)) (:foreground "#D6DA25"))))
